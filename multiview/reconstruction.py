'''
 Copied from EasyMocap
 Path: https://github.com/zju3dv/EasyMocap/blob/master/easymocap/mytools/reconstruction.py
'''
...
def batch_triangulate(keypoints_, Pall, keypoints_pre=None, lamb=1e3):
    ...
    keypoints = keypoints_[:, valid_joint]  # select joints that are at least detected in 2 views
